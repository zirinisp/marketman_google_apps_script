...
namespace Marketman {
    ...
    class InventoryCountResponse {
        ...
        static fromJSON(json: string): InventoryCountResponse {
    ...
    class InventoryCount {
        ...
        static fromJSON(json: string): InventoryCount {
            return JSON.parse(json);
        }
    ...
    class InventoryLine {
        ...
        static fromJSON(json: string): InventoryLine {
            return JSON.parse(json);
        }
    }
    ...
    function convertStringToDate(mmDateString: string) {
    ...
    export class BuyerApi {
        ...
        getInventoryCounts(fromDate: Date, toDate: Date = new Date(), getLineDetails: Boolean = true, buyer: Buyer = this.defaultBuyer()): InventoryCountResponse {
            ...
            var response = this.buyerRequest(endPoint, queryData);
            var inventoryResponse = InventoryCountResponse.fromJSON(response);
    ...
    export class Test {
        ...
        constructor(buyerApi?: BuyerApi) {
            if (buyerApi) {
                ...
                this.buyerApi = new BuyerApi(mmApiKey, mmApiPassword);
            }
